...
contract SaffronERC20Staking is Ownable {
    ...
    uint256 public rewardEndBlock; // SFI Rewards end block
    ...
    /// @dev update the reward distributor
    ...
    /**
     * @dev deposit the user's asset to the pool
     * @param _pid the pool id where the user's asset is being deposited
    ...
    /**
     * @dev withdraw the user's asset from the specific pool
     * @param _pid the pool id where the user's asset is being withdrawn
    ...
    /// @dev emergencyWithdraw a user's asset in the specific pool in case of bugs
    ...
    /// @dev Safe sfi transfer function, supply rewards from the sfi rewarder contract
